...
macro_rules! pawn {
    ($id:tt, $color:tt) => {
        $crate::structs::Piece::new($id, $crate::structs::Pawn, $crate::structs::$color)
    };
}
...
macro_rules! knight {
    ($id:tt, $color:tt) => {
        $crate::structs::Piece::new($id, $crate::structs::Knight, $crate::structs::$color)
    };
}
...
macro_rules! bishop {
    ($id:tt, $color:tt) => {
        $crate::structs::Piece::new($id, $crate::structs::Bishop, $crate::structs::$color)
    };
}
...
macro_rules! rook {
    ($id:tt, $color:tt) => {
        $crate::structs::Piece::new($id, $crate::structs::Rook, $crate::structs::$color)
    };
}
...
macro_rules! queen {
    ($id:tt, $color:tt) => {
        $crate::structs::Piece::new($id, $crate::structs::Queen, $crate::structs::$color)
    };
}
...
macro_rules! king {
    ($id:tt, $color:tt) => {
        $crate::structs::Piece::new($id, $crate::structs::King, $crate::structs::$color)
    };
}